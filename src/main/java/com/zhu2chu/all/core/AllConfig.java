...
public class AllConfig extends JFinalConfig {
    ...
    public void configPlugin(Plugins me) {
        ...
        me.add(new H2ServerPlugin(p.getBoolean("enableWebServer", false)));
        ...
        dp1.addFilter(new StatFilter());//添加此过滤器，在DRUID监控页面[SQL监控]一项才有内容显示
        me.add(dp1);
    ...
    public static void main(String[] args) {
         ...
         */
        JFinal.start("src/main/config/app", 8022, "/", 5);
    ...
    private static Prop loadGlobalConfig() {
        return PropKit.use("global.secret");
    }
