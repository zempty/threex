...
/**
 * This example demonstrates ProgressMonitor usage. Progress Monitor can be used
 * to get the current progress information of the task being performed by Zip4j.
 * <br>
 * <br>
 * 
 * ProgressMonitor can be used to get information regarding any kind of task.
 * This example uses the adding files to Zip functionality. Information
 * regarding rest of the tasks is similar to this approach
 */
public class ProgressInformation {
    ...
    public ProgressInformation() {
        ...
        try {
            ...
            // When this variable is set, Zip4j will run any task in a new
            // thread
            // If this variable is not set, Zip4j will run all tasks in the
            // current
            // thread.
            ...
            // ProgressMonitor has two states, READY and BUSY. READY indicates
            // that
            // Zip4j can now accept any new tasks. BUSY indicates that Zip4j is
            // currently performing some task and cannot accept any new task at
            // the moment
            // Any attempt to perform any other task will throw an Exception
            while (progressMonitor.getState() == ProgressMonitor.STATE_BUSY) {
                // ProgressMonitor has a lot of useful information like, the
                // current
                // operation being performed by Zip4j, current file being
                // processed,
                // percentage done, etc. Once an operation is completed,
                // ProgressMonitor
                // also contains the result of the operation. If any exception
                // is thrown
                // during an operation, this is also stored in this object and
                // can be retrieved
                // as shown below
                ...
                // ProgressMonitor.OPERATION_ADD - files are being added to the
                // zip file
                // ProgressMonitor.OPERATION_EXTRACT - files are being extracted
                // from the zip file
                // ProgressMonitor.OPERATION_REMOVE - files are being removed
                // from zip file
                // ProgressMonitor.OPERATION_CALC_CRC - CRC of the file is being
                // calculated
                // ProgressMonitor.OPERATION_MERGE - Split zip files are being
                // merged
            ...
            // ProgressMonitor.RESULT_WORKING - Zip4j is still working and is
            // not
            // yet done with the current operation
            // ProgressMonitor.RESULT_ERROR - An error occurred during
            // processing
