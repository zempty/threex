...
/**
 * This example demonstrates the use of ZipOutputStreams. ZipOutputStreams can
 * be used to create zip files "on the fly" with all compression and encryption
 * being done in memory
 */
    ...
    public CreateZipWithOutputStreams() {
        ...
        try {
            ...
            outputStream = new ZipOutputStream(
                    new FileOutputStream(new File("c:\\ZipTest\\CreateZipFileWithOutputStreams.zip")));
