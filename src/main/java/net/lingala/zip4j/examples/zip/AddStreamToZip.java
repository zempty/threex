...
/**
 * Example demonstrating creation of a zip file with content from an
 * inputstream. This inputstream may not be a file existing on the disk. Notes:
 * <br>
 * <ul>
 * <li>Standard zip encryption cannot be used with this functionality unless you
 * know CRC of the stream to be added in advance. If this is the case, then this
 * CRC has to be set in ZipParameters.setSourceFileCRC(int) before calling
 * ZipFile.addStream() method. There are no limitations for AES encryption</li>
 * <li>Zip4j wont work in threaded mode with this method. i.e, setting
 * ZipFile.setRunInThread() will not have any effect and this method will
 * execute in the same thread and not in a different thread</li>
 * <li>InputStream will NOT be closed after content is added to the zip file
 * </li>
 * </ul>
 */
